...
- **Google Drive / Gemini**: Used for searching legacy and sensitive information. In some contexts, Gemini may also function as an assistant interface or data retrieval aid.
